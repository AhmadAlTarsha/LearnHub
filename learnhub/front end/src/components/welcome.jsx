  ...
  return (
    ...
    <Box sx={{ textAlign: "center", mb: 4 }}>
      ...
      <Typography variant="body1" sx={{ mb: 4 }}>
        We provide a variety of programming courses for all levels. Learn
        from experts, and enhance your skills to advance your career.
      </Typography>
    </Box>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <Typography variant="body2">
              Access a wide range of programming courses and start coding
              your own applications today.
            </Typography>
          </CardContent>
        </Card>
      </Grid>
      ...
      <Grid item xs={12} md={4}>
        <Card>
          ...
          <CardContent>
            ...
            <Typography variant="body2">
              Enhance your career prospects by learning the latest
